...
1. Make sure your user is a sudoer (if you are not the admin, log in as the admin and sudo adduser <yourusername> adm sudo dialout audio lpadmin sambashare  and then restart the computer)
